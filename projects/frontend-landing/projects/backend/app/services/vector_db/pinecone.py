...
class PineconeVectorDB:
    """Pinecone vector database service for patent embeddings."""
    ...
    def __init__(self, api_key: str, index_name: str) -> None:
        ...
        try:
            ...
            raise VectorDBError("Failed to initialize Pinecone") from e
    ...
    async def get_or_create(
        ...
        try:
            ...
            raise VectorDBError("Pinecone get_or_create failed") from e
    ...
    async def query_similar(
        ...
        *,
        ...
        try:
            ...
            raise VectorDBError("Pinecone query_similar failed") from e
